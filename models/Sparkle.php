...
class Sparkle extends ActiveRecord {
    ...
    public const SCORE_VIEWS_1000               = 250;  //Someone viewed your artwork for the 1000th time
    public const SCORE_REACTION                 = 25;   //Someone reacted to your artwork
    public const SCORE_TAG                      = 50;   //You taged someones artwork
