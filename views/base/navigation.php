...
<nav class="navbar">
    <div class="container">
        ...
        <div class="navbar-brand is-justify-content-space-evenly">
            <a class="navbar-item brand-text is-tab <?= HTTP::route() != '/gallery/' ?: 'is-active' ?>" href="<?= HTTP::url('/')?>"><img src="<?= Kiss::$app->logo ?>" /></a>
            <a class="navbar-item has-icon is-tab <?= !Strings::startsWith(HTTP::route(), '/gallery/') || HTTP::route() == '/gallery/' ?: 'is-active' ?>" title="Gallery" href="<?= HTTP::url('/gallery/browse')?>"><i class="fal fa-images"></i></a>
            <?php if ($user): ?>
                ...
                <a class="navbar-item has-icon is-tab is-hidden-desktop <?= !Strings::endsWith(HTTP::route(), '/profile/@me/') ?: 'is-active' ?>" title="Submissions" href="<?= HTTP::url('/profile/@me/')?>"><i class="fal fa-user"></i></a>
            <?php else: ?>
                    <a class="navbar-item has-icon is-tab is-hidden-desktop <?= !Strings::endsWith(HTTP::route(), '/login') ?: 'is-active' ?>" title="Submissions" href="<?= HTTP::url('/login')?>"><i class="fal fa-user"></i></a>    
            <?php endif; ?>
        </div>
